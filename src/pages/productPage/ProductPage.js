      ...
      <Query query={PRODUCT_BY_ID(this.id)}>
        {({ loading, data, error }) => {
          ...
          if (data.product) {
            ...
            return (
              <StyledProductPageWrapper>
                {/* Adding data-testid attribute to the product gallery container */}
                <StyledProductGalleryContainer data-testid="product-gallery"> 
                  <StyledThumbnailsContainer>
                ...
                <StyledProductDetails>
                  ...
                  {/* Adding data-testid attribute to the product description */}
                  <StyledDescription data-testid="product-description">
